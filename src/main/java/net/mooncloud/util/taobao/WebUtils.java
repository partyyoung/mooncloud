package net.mooncloud.util.taobao;
...
public abstract class WebUtils
{
	...
	private static String DEFAULT_CHARSET = Constants.CHARSET_GBK;// Constants.CHARSET_UTF8;
	...
	private static String _doPostWithFile(String url, Map<String, String> params, Map<String, FileItem> fileParams, String charset, int connectTimeout, int readTimeout,
			Map<String, String> headerMap) throws IOException
	{
	...
	public static String doGet(String url, Map<String, String> params, String charset) throws IOException
	{
		if (!StringUtils.isEmpty(charset))
		{
			...
			{
				DEFAULT_CHARSET = Constants.CHARSET_UTF8;
			}
			else if (charset.toUpperCase().startsWith("GB"))
			{
				DEFAULT_CHARSET = Constants.CHARSET_GBK;// Constants.CHARSET_UTF8;
			}
		}
		HttpURLConnection conn = null;
		String rsp = null;
	...
	private static HttpURLConnection getConnection(URL url, String method, String ctype, Map<String, String> headerMap) throws IOException
	{
		...
		{
			return getConnection(url, method, ctype, headerMap, PROXY);
		}
	...
	public static String doGet(HttpClient httpclient, HttpGet httpGet, String charset) throws IOException
	{
		try
		{
	...
	{
		// WebUtils.PROXY = new Proxy(Proxy.Type.HTTP, new InetSocketAddress("36.250.69.4", 80));
		// WebUtils.PROXY = proxy;
		System.out.println(WebUtils.doPost("http://detail.tmall.com/item.htm?id=17611154210", null, "gb2312", 500, 500));
	}
}

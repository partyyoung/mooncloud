...
public class DBRecordReader extends RecordReader<LongWritable, Record> {

	private static final Log LOG = LogFactory.getLog(DBRecordReader.class);

	private ResultSet results = null;

	private Class<Record> inputClass;
	...
	public DBRecordReader(DBInputFormat.DBInputSplit split,
			Class<Record> inputClass, Configuration conf, Connection conn,
	 ...
	 */
	@Deprecated
	public boolean next(LongWritable key, Record value) throws IOException {
		this.key = key;
		this.value = value;
		return nextKeyValue();
	}
